...
<style type="text/css">
.all2 {width: 750px; height: 450px; background-color: #79797985; margin: auto; font-family: arial;margin-top: 100px;border-radius: 15px;color: #ffffffc2;}
...
select {width:395px; height:20px; margin-top:10px; border: #80d894d6 1px solid; border-radius: 20px;padding-left: 8px; height: 25px;}
...
.change_avata { color:#04771ed6; cursor: pointer;display: inline-block;width: 400px; height: 40px; margin-top: 20px; border: #80d894d6 1px solid; border-radius: 20px; padding-top: 5px; padding-left: 15px; background-color: #fff;}
</style>
</head>
...
<form method="POST" enctype="multipart/form-data">
            ...
            <div id="button">
                 <button type="submit" name="save" value="save">Thêm</button>
