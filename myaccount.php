                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group"><?php if($admin=='true') { ?>
                                                                ...
                                                                <button class="btn btn-primary btn-sm"  value="Sửa thông tin"><a href="../dk_hoclai.php?id=<?php echo $id;?>" style="text-decoration: none; color: #fff;">Đăng ký học lại</a></button>
