            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            <a href="manager_hoclai.php?sldong=3&page=1" style="text-decoration: none; color: #fff;">
                            <div class="card text-white bg-secondary shadow">
                                <div class="card-body">
                                    <p class="m-0">Quản lý học lại</p>
                                    <p class="text-white-50 small m-0">Xem học lại vui không</p>
                                </div>
                            </div></a>
                        </div>
                    </div>
...
} ob_end_flush(); include('footer.php');
?>
