...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2020 at 05:33 AM
...
('LTMK1', 'Lập trình máy tính 1'),
('LTMT2', 'Lập trình máy tính 2'),
('LTMT3', 'Lập trình máy tính 3'),
('QTM', 'Quản trị mạng'),
('TKDH', 'Thiết kế đồ họa'),
('UDPM1', 'Ứng dụng phần mềm 1'),
('UDPM2', 'Ứng dụng phần mềm 2'),
('UDPM3', 'Ứng dụng phần mềm 3'),
('UDPM4', 'Ứng dụng phần mềm 4');
...
INSERT INTO `hoclai` (`id`, `name`, `class`, `mon`) VALUES
('35', 'Trịnh Sỹ Dự', 'Ứng dụng phần mềm 4', 'JAVA ANDROID '),
('60', 'Tiêu Văn Hiền', 'Lập trình máy tính 1', 'JAVA '),
('cd1124', 'Phan Kiên Trung', 'Lập trình máy tính 3', 'JAVA ANDROID C# '),
('CD1881142', 'Ngô Đức Long', 'Thiết kế đồ họa', 'JAVA '),
('ưq3e43423', 'sdsdasdfsaf', 'Ứng dụng phần mềm 4', 'JAVA ANDROID C# ASP.NET ');
