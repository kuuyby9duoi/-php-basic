...
<style>
.container {width:300px; height:380px; margin:auto;background-color:#66666659; margin-top:25px; font-size:16px; font-family:Arial, Helvetica, sans-serif;border-radius:10px;text-align: center;}
...
.submit {width:150px; height:40px; margin-top:10px; background-color: #cc6f4d73; border: #80d894d6 1px solid; border-radius: 20px;color: #FFF;transition: transform .2s;}
...
<div class="container">
        <form method="post">
	        ...
	        <div><input type="password" name="password" placeholder="  Nhập mật khẩu cũ" class="text"></div>
	        <div><input type="password" name="newpassword" placeholder="  Nhập mật khẩu mới" class="text"></div>
	        <div><input type="password" name="repassword" placeholder="  Nhập lại mật khẩu mới" class="text"></div>
...
<?php 
	...
	{	$acc=$_GET['acc'];
	   ...
	   if($newpassword==$repassword)
	   {
	   	...
	   	if($password==$getpass)
	   	{
	   		$sql_editpass="update khachhang set password='$newpassword' where id='$id'";
